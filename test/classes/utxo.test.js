...
import { createUTXO, getUTXO, forgeTx, casts} from '../../src/index.js'

const { Transaction, Script } = nimble.classes

test('createUTXO() accepts Mattercloud api params', t => {
  const params = {
...
test('createUTXO() accepts WOC api params', t => {
  const params = {
    "height": 578325,
    "tx_pos": 0,
